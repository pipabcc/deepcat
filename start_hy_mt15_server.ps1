...
$Model = Join-Path $Root "models\hy-mt-1.8b\HY-MT1.5-1.8B-Q4_K_M.gguf"
$LogDir = Join-Path $Root "logs"
$OutLog = Join-Path $LogDir "llama_cpp_server_hy-mt15-1.8b-q4_k_m.log"
$ErrLog = Join-Path $LogDir "llama_cpp_server_hy-mt15-1.8b-q4_k_m.err.log"
